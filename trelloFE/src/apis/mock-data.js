export const mockData = {
    board: {
      _id: 'board-id-01',
      title: 'SonPham MERN Stack Board',
      ...
      columns: [
          ...
          cards: [
            {
              ...
              cover: 'https://s3.ap-southeast-1.amazonaws.com/cdn.vntre.vn/default/avatar-meo-14-1724730902.jpg',
        ...
        },
        {
          ...
          cardOrderIds: ['card-id-111-placeholder'],
          cards: [
            { _id: 'card-id-111-placeholder', boardId: 'board-id-01', columnId: 'column-id-04', title: 'Title of card 111', description: null, cover: null, memberIds: [], comments: [], attachments: [], 
              FE_PlaceHolder: true
             },
