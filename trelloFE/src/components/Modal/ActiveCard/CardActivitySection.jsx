...
function CardActivitySection({onAddCardComments, comments = []}) {
  ...
  const handleAddCardComment = (event) => {
    ...
    if (event.key === 'Enter' && !event.shiftKey) {
      ...
      const commentToAdd = {
        user_avatar: currentUser?.user.avatar,
        user_display_name: currentUser?.user.display_name,
      ...
      onAddCardComments(commentToAdd).then(() => {event.target.value = ''})
    }
  }
